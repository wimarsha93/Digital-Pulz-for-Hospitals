...
<?php } ?>
						...
						<div class="row">
							<div class='box-body'>
								<div id="w1" class="alert alert-danger"
								style='height: 55px; position: relative; left: 250px; top: 10px; width: 74%;'>
								The last patient<strong> is still in the queue </strong> <br> <input
								type="button" value="CheckOut"
								onClick="window.location = '<?php echo "../../queue_c/remove/" . $checkoutlast; ?>'"
								class='btn' />
							</div>
						</div>
					</div>
