                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="treeview" >
                        ...
                        <ul class="treeview-menu">
                            <li class="navsidebar"><a href="<?php echo site_url("/questionnaire_c/add"); ?>"><i class="fa fa-circle-o"></i> Add Questionnaire</a></li>
                            <li class="navsidebar"><a href="<?php echo site_url("/preferences_c/view_questionnaire"); ?>"><i class="fa fa-circle-o"></i> View Questionnaire</a></li>
                        </ul>
                    </li>

                    <li class="header" id="patient_overview_header" style="display:none;">PATIENT OVERVIEW</li>
                    <li class="patient_overview" style="display:none;">
                        <a href="#">
                            <i class="fa  fa-stack-exchange"></i> <span>Overview</span>
                        </a>
                    </li>
                    <li class="patient_overview" style="display:none;">
                        <a href="#">
                            <i class="fa fa-level-up"></i> <span>Create A Visit</span>
                        </a>
                    </li>
                    <li class="patient_overview" style="display:none;">
                        <a href="#">
                            <i class="fa fa-file-text-o"></i> <span>Add Note</span>
                        </a>
                    </li>
                    <li class="patient_overview" style="display:none;">
                        <a href="#">
                            <i class="fa fa-h-square"></i> <span>Add Allergy</span>
                        </a>
                    </li>
                    <li class="patient_overview" style="display:none;">
                        <a href="#">
                            <i class="fa fa-paperclip"></i> <span>Add Attachment</span>
                        </a>
                    </li>
                    <li class="patient_overview" style="display:none;">
                        <a href="#">
